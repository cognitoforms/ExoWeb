...
(function() {
	...
	ExoWeb.Model.ModelType = ModelType;
	ModelType.registerClass("ExoWeb.Model.ModelType");

	///////////////////////////////////////////////////////////////////////////////
	ExoWeb.Model.ModelTypeClass = ModelTypeClass = { Intrinsic: "intrinsic", Entity: "entity", EntityList: "entitylist" }
	...
	ExoWeb.Model.ModelProperty = ModelProperty;
	ModelProperty.registerClass("ExoWeb.Model.ModelProperty");
	...
	ModelObject.prototype = {
		...
		addPropertyValidated: function(property, handler) {
		...
		_raisePropertyValidating: function(property) {
		...
		addPropertyValidating: function(property, handler) {
			var handlers = this._propertyValidating[property];
	...
	ExoWeb.Model.ModelObject = ModelObject;
	ModelObject.registerClass("ExoWeb.Model.ModelObject");
	...
	ModelRule.prototype = {
		...
		length: function(maxChars) {
			var prop = this;
			var err = new ModelIssue(prop.get_label() + " must be " + maxChars + " characters or less", [prop]);
	...
	ExoWeb.Model.ModelRule = ModelRule;
	ModelRule.registerClass("ExoWeb.Model.ModelRule");
	...
	ExoWeb.Model.ModelIssue = ModelIssue;
	ModelIssue.registerClass("ExoWeb.Model.ModelIssue");
	...
	///////////////////////////////////////////////////////////////////////////////
	function Adapter(target, propertyChain, format, options) {
