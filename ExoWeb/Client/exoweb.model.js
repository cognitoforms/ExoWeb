...
(function() {
	...
	Model.prototype = {
		addType: function(name, baseClass, properties) {
			...
			jstype.formats = {};
			jstype.formats.prototype = baseClass.formats;
...
function getAdapter(component, targetProperty, templateContext, properties) {
	...
	return new Adapter(templateContext.dataItem, props, format, properties);
}
...
String.formats.$default = new Format({});
...
/// </example>
///////////////////////////////////////////////////////////////////////////////
PropertyChain = function(properties) {
